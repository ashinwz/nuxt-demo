<template>
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 md:w-1/5 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
        <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <!-- add a icon on the left side of Flowbite -->
            <div class="flex items-center justify-center mb-2">
                <!-- make the svg on the same row with flowbite h1 -->
                <h1 class="text-2xl mb-2 font-semibold">Flowbite</h1>
            </div>
            <p class="text-gray-500 mb-4 text-sm">A free Tailwind CSS template pack</p>
            <!-- add a line to seprate -->
